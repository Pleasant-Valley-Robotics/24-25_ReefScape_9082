...
public class RobotContainer {
    ...
    Trigger CoralL1ReefA = J2Button1.and(J2Button2);
    Trigger CoralL1ReefB;
    Trigger CoralL1ReefC;
    Trigger CoralL1ReefD;
    Trigger CoralL1ReefE;
    Trigger CoralL1ReefF;
    Trigger CoralL1ReefG;
    Trigger CoralL1ReefH;
    Trigger CoralL1ReefI;
    Trigger CoralL1ReefJ;
    Trigger CoralL1ReefK;
    Trigger CoralL1ReefL;
    Trigger CoralL2ReefA;
    Trigger CoralL2ReefB;
    Trigger CoralL2ReefC;
    Trigger CoralL2ReefD;
    Trigger CoralL2ReefE;
    Trigger CoralL2ReefF;
    Trigger CoralL2ReefG;
    Trigger CoralL2ReefH;
    Trigger CoralL2ReefI;
    Trigger CoralL2ReefJ;
    Trigger CoralL2ReefK;
    Trigger CoralL2ReefL;
    Trigger CoralL3ReefA;
    Trigger CoralL3ReefB;
    Trigger CoralL3ReefC;
    Trigger CoralL3ReefD;
    Trigger CoralL3ReefE;
    Trigger CoralL3ReefF;
    Trigger CoralL3ReefG;
    Trigger CoralL3ReefH;
    Trigger CoralL3ReefI;
    Trigger CoralL3ReefJ;
    Trigger CoralL3ReefK;
    Trigger CoralL3ReefL;
    Trigger CoralL4ReefA;
    Trigger CoralL4ReefB;
    Trigger CoralL4ReefC;
    Trigger CoralL4ReefD;
    Trigger CoralL4ReefE;
    Trigger CoralL4ReefF;
    Trigger CoralL4ReefG;
    Trigger CoralL4ReefH;
    Trigger CoralL4ReefI;
    Trigger CoralL4ReefJ;
    Trigger CoralL4ReefK;
    Trigger CoralL4ReefL;
