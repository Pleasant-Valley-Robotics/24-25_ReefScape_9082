...
public class RobotContainer {
    ...
    Trigger CoralL1ReefA = J2Button3.and(J2Button7);
    Trigger CoralL1ReefB = J2Button3.and(J2Button8);
    Trigger CoralL1ReefC = J2Button3.and(J2Button9);
    Trigger CoralL1ReefD = J2Button3.and(J2Button10);
    Trigger CoralL1ReefE = J2Button3.and(J2Button11);
    Trigger CoralL1ReefF = J2Button3.and(J2Button12);
    Trigger CoralL1ReefG = J2Button3.and(J3Button7);
    Trigger CoralL1ReefH = J2Button3.and(J3Button8);
    Trigger CoralL1ReefI = J2Button3.and(J3Button9);
    Trigger CoralL1ReefJ = J2Button3.and(J3Button10);
    Trigger CoralL1ReefK = J2Button3.and(J3Button11);
    Trigger CoralL1ReefL = J2Button3.and(J3Button12);
    Trigger CoralL2ReefA = J2Button4.and(J2Button7);
    Trigger CoralL2ReefB = J2Button4.and(J2Button8);
    Trigger CoralL2ReefC = J2Button4.and(J2Button9);
    Trigger CoralL2ReefD = J2Button4.and(J2Button10);
    Trigger CoralL2ReefE = J2Button4.and(J2Button11);
    Trigger CoralL2ReefF = J2Button4.and(J2Button12);
    Trigger CoralL2ReefG = J2Button4.and(J3Button7);
    Trigger CoralL2ReefH = J2Button4.and(J3Button8);
    Trigger CoralL2ReefI = J2Button4.and(J3Button9);
    Trigger CoralL2ReefJ = J2Button4.and(J3Button10);
    Trigger CoralL2ReefK = J2Button4.and(J3Button11);
    Trigger CoralL2ReefL = J2Button4.and(J3Button12);
    Trigger CoralL3ReefA = J2Button5.and(J2Button7);
    Trigger CoralL3ReefB = J2Button5.and(J2Button8);
    Trigger CoralL3ReefC = J2Button5.and(J2Button9);
    Trigger CoralL3ReefD = J2Button5.and(J2Button10);
    Trigger CoralL3ReefE = J2Button5.and(J2Button11);
    Trigger CoralL3ReefF = J2Button5.and(J2Button12);
    Trigger CoralL3ReefG = J2Button5.and(J3Button7);
    Trigger CoralL3ReefH = J2Button5.and(J3Button8);
    Trigger CoralL3ReefI = J2Button5.and(J3Button9);
    Trigger CoralL3ReefJ = J2Button5.and(J3Button10);
    Trigger CoralL3ReefK = J2Button5.and(J3Button11);
    Trigger CoralL3ReefL = J2Button5.and(J3Button12);
    Trigger CoralL4ReefA = J2Button6.and(J2Button7);
    Trigger CoralL4ReefB = J2Button6.and(J2Button8);
    Trigger CoralL4ReefC = J2Button6.and(J2Button9);
    Trigger CoralL4ReefD = J2Button6.and(J2Button10);
    Trigger CoralL4ReefE = J2Button6.and(J2Button11);
    Trigger CoralL4ReefF = J2Button6.and(J2Button12);
    Trigger CoralL4ReefG = J2Button6.and(J3Button7);
    Trigger CoralL4ReefH = J2Button6.and(J3Button8);
    Trigger CoralL4ReefI = J2Button6.and(J3Button9);
    Trigger CoralL4ReefJ = J2Button6.and(J3Button10);
    Trigger CoralL4ReefK = J2Button6.and(J3Button11);
    Trigger CoralL4ReefL = J2Button6.and(J3Button12);
    ...
    private void configureBindings() {
        ...
        if(joystick2.getRawButton(0) == true)   //This button needs to change based off of what we want on the joystick
        {
            HumanPlayerStation = true;
        }
        if(joystick2.getRawButton(1) == true)   //This button needs to change based off of what we want on the joystick
        {
